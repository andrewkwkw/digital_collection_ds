...
<div class="space-y-4 border-t border-gray-200 dark:border-gray-700 pt-6">
    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
        ...
        @if ($archive->number)
            <div>
                <dt class="font-semibold text-gray-700 dark:text-gray-300">{{ __('Nomor Dokumen') }}</dt>
                <dd class="text-gray-600 dark:text-gray-400">{{ $archive->number }}</dd>
            </div>
        @endif

        @if ($archive->date)
            <div>
                <dt class="font-semibold text-gray-700 dark:text-gray-300">{{ __('Tahun') }}</dt>
                <dd class="text-gray-600 dark:text-gray-400">{{ $archive->date }}</dd>
            </div>
        @endif
