            ...
            <div
                ...
                <div class="p-8 text-gray-900 dark:text-gray-100">
                    <form method="POST" action="{{ route('admin.archive.store') }}" enctype="multipart/form-data"
                        ...
                        <div
                            class="bg-gray-50/50 dark:bg-gray-900/20 p-6 rounded-2xl border border-dashed border-gray-200 dark:border-gray-700">
                            <label for="documents"
                            ...
                            <div class="relative group">
                                <input type="file" id="documents" name="documents[]" multiple accept="application/pdf"
                                    required class="block w-full text-sm text-gray-500 dark:text-gray-400
                                ...
                                <p
                                    class="mt-3 text-xs text-gray-500 dark:text-gray-400 flex items-center gap-1 font-medium">
                        ...
                        <div class="border-t border-gray-100 dark:border-gray-700 pt-8">
                            <div class="flex items-center gap-2 mb-8">
                                <span
                                    class="w-8 h-8 rounded-full bg-brand-500 text-white flex items-center justify-center text-xs font-bold">2</span>
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-x-8 gap-y-6">
                                <div class="md:col-span-2">
                                    ...
                                    <x-text-input id="title"
                                        ...
                                        placeholder="Masukkan judul utama arsip..." />
                                    <x-input-error :messages="$errors->get('title')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="creator" :value="__('Pembuat (Creator)')"
                                        class="font-bold text-gray-700 dark:text-gray-300" />
                                    <x-text-input id="creator"
                                        class="block mt-1 w-full bg-gray-50/50 dark:bg-gray-900/40 border-gray-200 focus:border-brand-500 focus:ring-brand-500 rounded-xl"
                                        type="text" name="creator" :value="old('creator')"
                                        placeholder="Nama individu atau instansi" />
                                    <x-input-error :messages="$errors->get('creator')" class="mt-2" />
                                </div>

                                <div>
                                    <x-input-label for="date" :value="__('Tanggal Dokumen')"
                                        class="font-bold text-gray-700 dark:text-gray-300" />
                                ...
                                <div class="md:col-span-2">
                                    <x-input-label for="subject" :value="__('Subjek / Kata Kunci')"
                                        class="font-bold text-gray-700 dark:text-gray-300" />
                                    <textarea id="subject" name="subject" rows="2"
                                        class="block mt-1 w-full bg-gray-50/50 dark:bg-gray-900/40 border-gray-200 dark:border-gray-700 dark:text-gray-100 focus:border-brand-500 focus:ring-brand-500 rounded-xl shadow-sm transition-all"
                                        placeholder="Contoh: Kepegawaian, Laporan Tahunan, SK Rektor">{{ old('subject') }}</textarea>
                                    <x-input-error :messages="$errors->get('subject')" class="mt-2" />
                                </div>
                                <div class="md:col-span-2">
                                    <x-input-label for="description" :value="__('Deskripsi Dokumen')"
                                        class="font-bold text-gray-700 dark:text-gray-300" />
                                ...
                                <div
                                    class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mt-4 p-6 bg-gray-50/30 dark:bg-gray-900/10 rounded-2xl border border-gray-100 dark:border-gray-700">
                                    <div>
                                        <x-input-label for="publisher" :value="__('Penerbit')"
                                            class="text-xs uppercase tracking-wider font-black text-gray-400" />
                                        <x-text-input id="publisher"
                                            class="block mt-1 w-full text-sm border-gray-200 dark:bg-gray-800 rounded-lg"
                        ...
                        <div
                            class="flex items-center justify-between mt-10 pt-6 border-t border-gray-100 dark:border-gray-700">
                            ...
                            <x-primary-button
                                class="bg-brand-500 hover:bg-brand-600 px-8 py-3 rounded-xl shadow-lg shadow-brand-500/20 transform transition active:scale-95">
