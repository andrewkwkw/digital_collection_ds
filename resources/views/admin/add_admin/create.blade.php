<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-xl mx-auto sm:px-6 lg:px-8">
            <div
                class="bg-white dark:bg-gray-800 overflow-hidden shadow-2xl shadow-brand-500/5 rounded-3xl border border-gray-100 dark:border-gray-700">
                <div class="p-8">
                    <div class="mb-8">
                        <h3 class="text-lg font-bold text-gray-800 dark:text-white">Informasi Akun</h3>
                        <p class="text-sm text-gray-500 dark:text-gray-400">Pastikan alamat email aktif untuk akses
                            masuk sistem.</p>
                    </div>
                    ...
                    <form method="POST" action="{{ route('admin.store') }}" class="space-y-6">
                        ...
                        <div>
                            ...
                            <x-text-input id="name"
                                class="block w-full border-gray-200 dark:border-gray-700 focus:border-brand-500 focus:ring-brand-500 rounded-xl"
                        ...
                        <div class="flex items-center justify-between">
                            ...
                            <x-primary-button
                                class="bg-brand-600 hover:bg-brand-700 focus:bg-brand-700 active:bg-brand-800 rounded-xl px-6 py-3 shadow-lg shadow-brand-500/20">
                                <svg class="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                        d="M5 13l4 4L19 7" />
                                </svg>
