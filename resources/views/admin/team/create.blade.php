<x-app-layout>
    {{-- HEADER (Style disamakan dengan Halaman Edit) --}}
    <x-slot name="header">
            ...
            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <p class="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                        Tambahkan dosen atau staff baru ke dalam struktur organisasi.
                    </p>
                </div>
            </div>
                ...
                <div class="grid lg:grid-cols-3 gap-8">
                    ...
                    <div class="lg:col-span-1 space-y-6">
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                            ...
                            {{-- Init Alpine without existing photo --}}
                            <div x-data="{ 
                                photoName: null, 
                                photoPreview: null 
                            }">
                                ...
                                <div class="mt-2" x-show="!photoPreview">
                                    {{-- Menggunakan style Brand color pada hover --}}
                                    <div @click="$refs.photo.click()" class="flex flex-col items-center justify-center w-full h-64 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer bg-gray-50 dark:bg-gray-900 hover:bg-white dark:hover:bg-gray-800 hover:border-brand-500 dark:hover:border-brand-500 transition-all group">
                                        ...
                                        <p class="text-sm font-medium text-gray-900 dark:text-white">Upload Foto</p>
                        ...
                        <div class="bg-white dark:bg-gray-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                            ...
                            <div x-data="{ fileName: '' }">
                                {{-- Hover Border menggunakan Brand Color, Icon PDF tetap Merah (sesuai request) --}}
                                <label class="flex flex-col items-center justify-center w-full h-32 border-2 border-dashed border-gray-300 dark:border-gray-600 rounded-xl cursor-pointer bg-gray-50 dark:bg-gray-900 hover:bg-white dark:hover:bg-gray-800 hover:border-brand-500 dark:hover:border-brand-500 transition-all group p-4 text-center">
                                    <div x-show="!fileName">
                                        {{-- Icon upload berubah warna ke brand saat hover --}}
                                        ...
                                        <p class="text-sm text-gray-500">Upload PDF (Max 5MB)</p>
                                    </div>
                    ...
                    <div class="lg:col-span-2 space-y-8">
                        ...
                        <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                            {{-- Header Section dengan styling Brand --}}
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div class="col-span-2 md:col-span-1">
                                    ...
                                    {{-- Menggunakan focus:ring-brand-500 --}}
                                    <input type="text" name="name" required value="{{ old('name') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all" placeholder="Contoh: Jhon Doe, S.Kom">
                                </div>
                                <div class="col-span-2 md:col-span-1">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Posisi / Role</label>
                                    <input type="text" name="position" required value="{{ old('position') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all" placeholder="Contoh: Mahasiswa Magang / Ketua Lab">
                                </div>
                                <div class="col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Email (Opsional)</label>
                                    <input type="email" name="email" value="{{ old('email') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all" placeholder="email@contoh.com">
                                </div>
                                 <div class="col-span-2 md:col-span-1">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Nomor Induk (NIP / NIM)</label>
                                    <input type="text" name="nip" value="{{ old('nip') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all" placeholder="Opsional">
                                </div>
                                <div class="col-span-2 md:col-span-1">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">NIDN (Khusus Dosen)</label>
                                    <input type="text" name="nidn" value="{{ old('nidn') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all" placeholder="Opsional">
                                </div>
                                <div class="col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Pendidikan / Status Saat Ini</label>
                                    <input type="text" name="education" value="{{ old('education') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all" placeholder="Contoh: Mahasiswa S1 Sastra Indonesia / S3 Filologi">
                                </div>
                                <div class="col-span-2 md:col-span-1">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Urutan Tampil (Opsional)</label>
                                    <input type="number" name="order" value="{{ old('order') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all">
                        ...
                        <div class="bg-white dark:bg-gray-800 p-8 rounded-2xl shadow-sm border border-gray-100 dark:border-gray-700">
                            ...
                            <div class="grid md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="text" name="sinta_id" value="{{ old('sinta_id') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Google Scholar ID</label>
                                    <input type="text" name="scholar_id" value="{{ old('scholar_id') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Scopus ID</label>
                                    <input type="text" name="scopus_id" value="{{ old('scopus_id') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all">
                                </div>
                                <div>
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Orcid ID</label>
                                    <input type="text" name="orcid_id" value="{{ old('orcid_id') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all">
                                </div>
                                <div class="col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Bidang Keahlian / Minat</label>
                                    <input type="text" name="expertise" value="{{ old('expertise') }}" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all" placeholder="Contoh: Video Editing, UI/UX, Sejarah Lokal">
                                    <p class="text-xs text-gray-500 mt-1">Pisahkan dengan koma</p>
                                </div>
                                <div class="col-span-2">
                                    <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">Fokus Riset / Project</label>
                                    <textarea name="research_focus" rows="3" class="w-full rounded-lg border-gray-300 dark:border-gray-600 dark:bg-gray-900 text-gray-900 dark:text-white focus:ring-brand-500 focus:border-brand-500 transition-all" placeholder="Deskripsikan project atau riset yang sedang dikerjakan...">{{ old('research_focus') }}</textarea>
                                </div>
                            </div>
                        </div>
